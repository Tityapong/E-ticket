...
export default function LoginPage() {
  ...
  return (
    <div className="flex  items-center justify-center bg-gradient-to-br from-teal-50  p-18">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                className="border-teal-200 focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20"
              />
            </div>
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link href="#" className="text-xs  hover:text-teal-800 hover:underline">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
                <Input
                  ...
                  required
                  className="border-teal-200 focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 pr-10"
                />
                <Button
                  type="button"
                  variant="ghost"
            ...
            <div className="relative">
              <div className="absolute inset-0 flex items-center">
                <span className="w-full border-t border-teal-200"></span>
              </div>
